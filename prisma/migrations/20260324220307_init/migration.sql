...
-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('MCQ', 'SELECT_ALL', 'MATCHING', 'FREE_RESPONSE');
...
-- CreateIndex
CREATE INDEX "Team_eventId_competitionId_idx" ON "Team"("eventId", "competitionId");
...
-- CreateIndex
CREATE INDEX "Resource_competitionId_idx" ON "Resource"("competitionId");
...
-- AddForeignKey
ALTER TABLE "Resource" ADD CONSTRAINT "Resource_competitionId_fkey" FOREIGN KEY ("competitionId") REFERENCES "Competition"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Announcement" ADD CONSTRAINT "Announcement_competitionId_fkey" FOREIGN KEY ("competitionId") REFERENCES "Competition"("id") ON DELETE SET NULL ON UPDATE CASCADE;
